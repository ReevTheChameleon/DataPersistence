...
public class SceneMainManager : LoneMonoBehaviour<SceneMainManager>{
	...
	private LoneCoroutine routineSineBumpScore;
	...
	private LoneCoroutine routineShakeHighscore;
	...
	protected override void Awake(){
		...
		routineSineBumpScore = new LoneCoroutine(
			()=>{ txtScoreNumber.fontSize=txtScoreFontSize; }
		);
		routineShakeHighscore = new LoneCoroutine(
